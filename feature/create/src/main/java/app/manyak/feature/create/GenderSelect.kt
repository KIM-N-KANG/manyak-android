...
internal fun GenderSelectField(
    ...
    val options =
        listOf<ManyakSelectOption<CharacterGender?>>(
            ManyakSelectOption(value = null, label = stringResource(R.string.create_gender_random)),
            ManyakSelectOption(value = CharacterGender.MALE, label = stringResource(R.string.create_gender_male)),
            ManyakSelectOption(value = CharacterGender.FEMALE, label = stringResource(R.string.create_gender_female)),
        )
