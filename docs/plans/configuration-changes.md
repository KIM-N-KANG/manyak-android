...
### 1단계 — 하네스에 지원 정책을 씁니다 (작성 당시 선행 작업)

작성 당시 "디바이스 지원 작성 예정" 자리에 위 결정 1~4와 검수 항목을 채우는 작업입니다. 현재 계약은 [Android Spec §3-3-4](../../../knk-harness/docs/spec/3-3-android-spec.md#3-3-4-디바이스접근성상태-복원), 구현 구조는 [Android Design §1-2-4](../../../knk-harness/docs/design/1-2-android-design.md#1-2-4-내비게이션과-화면), 선택 근거는 [Android ADR A-023](../../../knk-harness/docs/adr/1-3-android-adr.md#a-023)에 있습니다.
