 ...
 *
 * 로그아웃은 화면이 사라져도 끝나야 하므로 앱 스코프에서 실행된다(하네스 §3-3-4 로그아웃 절차).
 ...
 * 로그인 성공 결과.
 *
 * [isNewUser]가 참이면 신규 가입 초대 코드 안내 대상이다(공통 계약 FE-SCREEN-008).
 * 첫 방문 제품 온보딩(FE-SCREEN-007)과는 다른 기능이며 후자는 앱에 없다.
 */
