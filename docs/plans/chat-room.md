...
**제외** — 채팅 배경 이미지 마커(`[[image:<imageKey>]]`, 서버·AI·웹 모두 미구현), 채팅 공유
발급·열람(KNK-872), 크레딧 잔액·보상 표시(KNK-870), 첫 진입 오버레이 투어(추천 입력 위 1회성
힌트만 옮기고 투어는 컴포저 확정 이후 판단).
...
8. **삭제** (KNK-1035) — 옵션 메뉴·확인 다이얼로그·204·404·복귀 백스택.
