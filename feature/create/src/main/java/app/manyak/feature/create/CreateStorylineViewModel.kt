            ...
            val PLACEHOLDER_STORYLINES: List<String> =
                listOf(
                    "눈을 떠보니 낯선 궁전의 침대 위. 거울 속에는 어제 읽다 잠든 소설 속 " +
                        "비운의 황녀가 서 있다. 원작대로라면 3년 뒤 폐위되어 유배지에서 생을 마감할 운명. " +
                        "하지만 결말을 아는 나는 오늘부터 조용히 판을 뒤집기로 한다. 첫걸음은 원작에서 " +
                        "나를 몰아냈던 재상의 약점을 먼저 손에 넣는 것이다.",
                    "평범한 회사원이던 내가 눈을 뜬 곳은 검과 마법의 대륙. 손에 쥔 것은 " +
                        "낡은 검 한 자루와 정체 모를 문장이 새겨진 목걸이뿐이다. 마을 사람들은 그 문장을 " +
                        "보자마자 무릎을 꿇었고, 나는 사라진 왕가의 마지막 후계자로 오해받기 시작한다. " +
                    ...
                    "출근길 버스에서 눈을 감았다 떴을 뿐인데, 세상이 멈춰 있었다. 움직이는 " +
                        ...
                        "그와 손을 잡아야만 시간이 다시 흐르지만, 그는 세상이 멈춘 이유를 숨기고 있다.",
                )
        }
    }
