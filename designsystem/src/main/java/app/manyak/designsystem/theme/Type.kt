...
val Pretendard =
    FontFamily(
        Font(DesignsystemR.font.pretendard_regular, FontWeight.Normal),
        Font(DesignsystemR.font.pretendard_medium, FontWeight.Medium),
        Font(DesignsystemR.font.pretendard_bold, FontWeight.Bold),
    )
...
val MaruBuri =
    FontFamily(
        Font(DesignsystemR.font.maru_buri_regular, FontWeight.Normal),
        Font(DesignsystemR.font.maru_buri_bold, FontWeight.Bold),
    )
