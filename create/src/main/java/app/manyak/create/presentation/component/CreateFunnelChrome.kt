...
internal fun CreateStepIndicator(
    ...
    val description =
        stringResource(
            CreateR.string.create_step_progress,
    ...
    when (warning) {
        ...
        FunnelExitWarning.SAVED_DRAFT ->
            FunnelWarningDialog(
                ...
                descriptionRes = CreateR.string.create_saved_exit_warning_description,
                confirmRes = CreateR.string.create_saved_exit_warning_leave,
                dismissRes = CreateR.string.create_saved_exit_warning_stay,
                onConfirm = onConfirmLeave,
                onDismiss = onDismiss,
            )
    }
...
internal fun ReselectWarningDialog(
    ...
    FunnelWarningDialog(
        titleRes = CreateR.string.create_reselect_warning_title,
        descriptionRes = CreateR.string.create_reselect_warning_description,
        confirmRes = CreateR.string.create_reselect_warning_confirm,
        dismissRes = CreateR.string.create_reselect_warning_cancel,
