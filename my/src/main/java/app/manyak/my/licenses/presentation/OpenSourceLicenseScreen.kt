package app.manyak.my.licenses.presentation
...
fun OpenSourceLicenseScreen(
    ...
    Column(
        ...
        MyDetailHeader(titleRes = MyR.string.my_open_source_license, onBack = onBack)
        if (groups.isEmpty()) {
            LoadingContent()
        } else {
    ...
    LazyColumn(
        ...
        item(key = "description") {
            Text(
                ...
                text = stringResource(MyR.string.open_source_description),
        ...
        Row(
            ...
            Text(
                text =
                    stringResource(
                        if (isExpanded) {
                            MyR.string.open_source_license_collapse
                        } else {
                            MyR.string.open_source_license_expand
                        },
                    ),
