...
internal fun RemoveBlockDialog(
    ...
    ManyakDestructiveDialog(
        title = stringResource(ChatR.string.chat_composer_remove_block_title),
        description = stringResource(ChatR.string.chat_composer_remove_block_description),
        confirmLabel = stringResource(ChatR.string.chat_composer_remove_block_confirm),
        cancelLabel = stringResource(ChatR.string.chat_composer_remove_block_cancel),
        onConfirm = onConfirm,
        onDismiss = onDismiss,
    )
}
