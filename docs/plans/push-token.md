...
- 작성일: 2026-09-08
- 근거 정본: 하네스 `3-3-android-app.md §3-3-4 푸시 토큰 등록`, `docs/planning/android-module-architecture.md §3·§5`
...
5. **알림 권한 요청 여부는 프로세스 수명 변수로만 기억한다.** 구성 변경으로 Activity 가 재생성돼도
   같은 프로세스에서 다시 묻지 않고, 저장소는 두지 않는다 — 시스템이 두 번 거부 뒤 자동 거부한다.
