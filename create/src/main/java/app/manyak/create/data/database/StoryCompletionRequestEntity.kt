...
/**
 * 제출된 완성 요청 한 행. requestId 별로 여러 행이 공존하며, 결과 반영과 삭제는
 * 항상 requestId 단위다. 중첩 구조는 편집 초안과 같은 JSON 인코더를 쓴다.
 */
...
data class StoryCompletionRequestEntity(
    ...
    /** 제출한 초안을 처음 임시 저장한 시각(epoch millis). 여러 초안 이전에 제출한 요청은 null 이다. */
