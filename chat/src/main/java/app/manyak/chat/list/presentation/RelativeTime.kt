...
internal fun RelativeTime.label(): String =
    when (this) {
        RelativeTime.JustNow -> stringResource(ChatR.string.relative_time_just_now)
        is RelativeTime.Minutes -> stringResource(ChatR.string.relative_time_minutes, value)
        is RelativeTime.Hours -> stringResource(ChatR.string.relative_time_hours, value)
        RelativeTime.Today -> stringResource(ChatR.string.relative_time_today)
        RelativeTime.Yesterday -> stringResource(ChatR.string.relative_time_yesterday)
        is RelativeTime.Days -> stringResource(ChatR.string.relative_time_days, value)
