...
internal val WithdrawalConfirmations =
    listOf(
        WithdrawalConfirmation(
            titleRes = MyR.string.withdrawal_confirm_credit,
            descriptionRes = MyR.string.withdrawal_confirm_credit_description,
        ),
        WithdrawalConfirmation(
            titleRes = MyR.string.withdrawal_confirm_library,
            descriptionRes = MyR.string.withdrawal_confirm_library_description,
        ),
        WithdrawalConfirmation(
            titleRes = MyR.string.withdrawal_confirm_published,
            descriptionRes = MyR.string.withdrawal_confirm_published_description,
        ),
        WithdrawalConfirmation(
            titleRes = MyR.string.withdrawal_confirm_social_login,
            descriptionRes = MyR.string.withdrawal_confirm_social_login_description,
        ),
    )
