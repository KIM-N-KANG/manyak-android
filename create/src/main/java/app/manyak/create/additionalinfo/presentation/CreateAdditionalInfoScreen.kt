...
private fun CreateAdditionalInfoContent(
    ...
    FocusScrollMargin {
        Column(
            ...
            CreateStepIndicator(
                currentStep = 2,
                stepNameRes = CreateR.string.create_step_additional_info,
            )
            when {
...
private fun AdditionalInfoStepTitle(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(
            text = stringResource(CreateR.string.create_additional_title),
            style = ManyakTheme.typography.titleLarge,
            color = ManyakTheme.colors.text,
        )
        Text(
            text = stringResource(CreateR.string.create_additional_description),
    ...
    Column(
        ...
        Row(
            ...
            FunnelNeutralButton(
                ...
                label = stringResource(CreateR.string.create_cta_reselect_storyline),
                enabled = true,
                onClick = { onIntent(CreateAdditionalInfoIntent.ReselectStoryline) },
            )
            FunnelPrimaryButton(
                modifier = Modifier.weight(1f),
                label = stringResource(CreateR.string.create_cta_complete_story),
                enabled = true,
...
private fun StoryCompletionCostRow(modifier: Modifier = Modifier) {
    ...
    Row(
        ...
        Text(
            text = stringResource(CreateR.string.create_completion_credit_cost_label),
