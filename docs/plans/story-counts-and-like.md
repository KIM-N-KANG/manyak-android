...
8. 홈 진입 기본 정렬을 인기순에서 서버 기본값과 같은 최신순으로 바꿨습니다(하네스 [C-008](../../../knk-harness/docs/adr/1-1-client-adr.md#c-008), 공통·웹·Android spec 갱신). 정렬은 계속 항상 명시해 보냅니다. 웹은 별도 작업으로 맞춰야 합니다.
