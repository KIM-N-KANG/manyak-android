package app.manyak.my.profile.presentation
...
import app.manyak.my.profile.presentation.component.MyMenuItem
import app.manyak.my.profile.presentation.component.ProfileHeader
...
fun MyScreen(
    ...
    val linkSucceeded = stringResource(MyR.string.my_link_succeeded)
    val linkAlreadyLinked = stringResource(MyR.string.my_link_already_linked)
    val linkFailed = stringResource(MyR.string.my_link_failed)
    val providerLabels =
        mapOf(
            AuthProvider.GOOGLE to stringResource(MyR.string.my_provider_google),
            AuthProvider.KAKAO to stringResource(MyR.string.my_provider_kakao),
        )
    ...
    Column(
        ...
        MySection(labelRes = MyR.string.my_section_etc) {
            ...
            MyMenuItem(
                ...
                labelRes = MyR.string.my_open_source_license,
...
private fun AccountSection(
    ...
    MySection(labelRes = MyR.string.my_section_account, modifier = modifier) {
        ...
        MyMenuItem(
            ...
            labelRes = MyR.string.my_withdrawal,
...
private fun AppVersionMenuItem(modifier: Modifier = Modifier) {
    MyMenuItem(
        ...
        labelRes = MyR.string.my_app_version,
        onClick = null,
        modifier = modifier,
        trailing = {
            Text(
...
private fun rememberAppVersionName(): String {
    val context = LocalContext.current
    val unknown = stringResource(MyR.string.my_app_version_unknown)
...
private fun ThemeMenuItem(
    ...
    val (iconRes, descriptionRes) =
        when (themeMode) {
            ThemeMode.SYSTEM -> DesignsystemR.drawable.ic_display to MyR.string.my_theme_system
            ThemeMode.LIGHT -> DesignsystemR.drawable.ic_sun to MyR.string.my_theme_light
            ThemeMode.DARK -> DesignsystemR.drawable.ic_moon to MyR.string.my_theme_dark
        }
    MyMenuItem(
        iconRes = iconRes,
        labelRes = MyR.string.my_theme,
        onClick = onClick,
        modifier = modifier,
        trailing = {
            Text(
