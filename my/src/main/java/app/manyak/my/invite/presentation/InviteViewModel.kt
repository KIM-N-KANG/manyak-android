...
import app.manyak.my.invite.presentation.onboarding.inviteCodeErrorType
import app.manyak.my.invite.presentation.onboarding.inviteCodeMessageRes
import app.manyak.my.invite.presentation.onboarding.sanitizeInviteCode
...
class InviteViewModel
    ...
    constructor(
        ...
        private suspend fun redeem() {
            ...
            if (code.isEmpty()) {
                dispatchEvent(InviteEvent.SubmitFailed(MyR.string.invite_code_error_empty))
                return
            }
